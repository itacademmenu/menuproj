$(document).ready(function () {
    ...
    grid = $('#grid').grid({
        ...
        columns: [
            { field: 'name', title: 'Имя', type:'text', editor: true },
            { field: 'order', title: 'Заказ',  type:'text', editor: true },
            { field: 'comment', title: 'Комментарий',  type:'text', editor: true },
            { field: 'sum_paid', title: 'Сумма',  editor: true }
        ],
        pager: { limit: 5 }
    });
